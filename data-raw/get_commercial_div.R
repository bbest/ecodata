...
# Data are drawn from blend of VTR trip data, CFDBS prices, vessel 
# characteristics from PERMIT databases, 
# and major VTR gear by permit. Here "MA" and "NE" refer to the Mid-Atlantic 
# and New England regions respectively, and are 
# not derived by EPU.
